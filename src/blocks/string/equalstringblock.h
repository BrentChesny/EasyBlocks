#ifndef EQUALSTRINGBLOCK_H
#define EQUALSTRINGBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The EqualStringBlock class
 *
 * @author Brecht Vandevoort
 */
class EqualStringBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    EqualStringBlock()  : _left(NULL), _right(NULL) {}

    /**
     * @brief Destructor method
     */
    virtual ~EqualStringBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("String_EqualStringBlock");}
     ...
     */
    virtual Block* newInstance() const {return new EqualStringBlock();}
