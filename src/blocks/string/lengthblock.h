#ifndef LENGTHBLOCK_H
#define LENGTHBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The LengthBlock class
 *
 * @author Brent Chesny
 */
class LengthBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    LengthBlock()  : _expr(NULL) {}
     ...
     */
    virtual QString getId() const {return QString("String_LengthBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QString(QObject::tr("Length of") + " %p");}
     ...
     */
    virtual Block* newInstance() const {return new LengthBlock();}
