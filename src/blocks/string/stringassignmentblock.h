#ifndef STRINGASSIGNMENTBLOCK_H
#define STRINGASSIGNMENTBLOCK_H
...
/**
 * @brief The StringAssignmentBlock class
 *
 * @author Brecht Vandevoort
 */
class StringAssignmentBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    StringAssignmentBlock() : _variable(NULL), _expression(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~StringAssignmentBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("String_StringAssignmentBlock");}
     ...
     */
    virtual Block* newInstance() const {return new StringAssignmentBlock();}
