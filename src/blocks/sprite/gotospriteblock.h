#ifndef GOTOSPRITEBLOCK_H
#define GOTOSPRITEBLOCK_H

#include "../../statementblock.h"
#include "../../spriteblock.h"

/**
 * @brief The GoToSpriteBlock class
 *
 * @author Brecht Vandevoort
 */
class GoToSpriteBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    GoToSpriteBlock() : _spriteTarget(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~GoToSpriteBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_GoToSpriteBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Go To Sprite:") + QString(" %p "); }
     ...
     */
    virtual Block* newInstance() const {return new GoToSpriteBlock();}

private:
    SpriteBlock* _spriteTarget;
};

#endif // GOTOSPRITEBLOCK_H
