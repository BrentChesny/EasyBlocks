#ifndef SPRITEHEIGHTBLOCK_H
#define SPRITEHEIGHTBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The SpriteHeightBlock class
 *
 * @author Brecht Vandevoort
 */
class SpriteHeightBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor
     ...
     * @brief Destructor
     */
    virtual ~SpriteHeightBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_SpriteHeightBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Height");}
     ...
     */
    virtual Block* newInstance() const {return new SpriteHeightBlock();}
};

#endif // SPRITEHEIGHTBLOCK_H
