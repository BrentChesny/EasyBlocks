#ifndef SETINVISIBLEBLOCK_H
#define SETINVISIBLEBLOCK_H

#include "../../statementblock.h"
#include "../../expressionblock.h"

/**
 * @brief The SetInvisibleBlock class
 *
 * @author Brecht Vandevoort
 */
class SetInvisibleBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     ...
     * @brief Destructor
     */
    virtual ~SetInvisibleBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_SetInvisibleBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Set invisible");}
     ...
     */
    virtual Block* newInstance() const {return new SetInvisibleBlock();}
};

#endif // SETINVISIBLEBLOCK_H
