#ifndef ROTATESPRITEBLOCK_H
#define ROTATESPRITEBLOCK_H

#include "../../statementblock.h"
#include "../../expressionblock.h"

/**
 * @brief The RotateSpriteBlock class
 *
 * @author Brecht Vandevoort
 */
class RotateSpriteBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    RotateSpriteBlock() : _rotationValue(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~RotateSpriteBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_RotateSpriteBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Rotate") + QString(" %p ") + QObject::tr("degrees"); }
     ...
     */
    virtual Block* newInstance() const {return new RotateSpriteBlock();}

private:
    ExpressionBlock* _rotationValue;
};

#endif // ROTATESPRITEBLOCK_H
