#ifndef BOUNCEEDGEBLOCK_H
#define BOUNCEEDGEBLOCK_H

#include "../../statementblock.h"
#include "../../expressionblock.h"

/**
 * @brief The BounceEdgeBlock class
 *
 * @author Brent Chesny
 */
class BounceEdgeBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     ...
     * @brief Destructor
     */
    virtual ~BounceEdgeBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_BounceEdgeBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Bounce if touching edge");}
     ...
     */
    virtual Block* newInstance() const {return new BounceEdgeBlock();}
};

#endif // BOUNCEEDGEBLOCK_H
