#ifndef SPRITEXPOSBLOCK_H
#define SPRITEXPOSBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The SpriteXPosBlock class
 *
 * @author Brecht Vandevoort
 */
class SpriteXPosBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor
     ...
     * @brief Destructor
     */
    virtual ~SpriteXPosBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_SpriteXPosBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("X position");}
     ...
     */
    virtual Block* newInstance() const {return new SpriteXPosBlock();}
};

#endif // SPRITEXPOSBLOCK_H
