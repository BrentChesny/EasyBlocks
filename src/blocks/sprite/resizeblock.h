#ifndef RESIZEBLOCK_H
#define RESIZEBLOCK_H

#include "../../statementblock.h"
#include "../../expressionblock.h"

/**
 * @brief The ResizeBlock class
 *
 * @author Brecht Vandevoort
 */
class ResizeBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    ResizeBlock() : _increase(NULL) {}
     ...
     */
    virtual QString getId() const {return QString("Sprite_ResizeBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Change size by") + QString(" %p "); }
     ...
     */
    virtual Block* newInstance() const {return new ResizeBlock();}

private:
    ExpressionBlock* _increase;
};
