#ifndef MOVESTEPSBLOCK_H
#define MOVESTEPSBLOCK_H

#include "../../statementblock.h"
#include "../../expressionblock.h"

/**
 * @brief The MoveStepsBlock class
 *
 * @author Brent Chesny
 */
class MoveStepsBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    MoveStepsBlock() : _steps(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~MoveStepsBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_MoveStepsBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Move") + QString(" %p ") + QObject::tr("steps"); }
     ...
     */
    virtual Block* newInstance() const {return new MoveStepsBlock();}

private:
    ExpressionBlock* _steps;
};

#endif // MOVESTEPSBLOCK_H
