#ifndef SPRITEROTATIONBLOCK_H
#define SPRITEROTATIONBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The SpriteRotationBlock class
 *
 * @author Brecht Vandevoort
 */
class SpriteRotationBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor
     ...
     * @brief Destructor
     */
    virtual ~SpriteRotationBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_SpriteRotationBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Rotation");}
     ...
     */
    virtual Block* newInstance() const {return new SpriteRotationBlock();}
};

#endif // SPRITEROTATIONBLOCK_H
