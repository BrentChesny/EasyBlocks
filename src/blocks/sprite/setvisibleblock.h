#ifndef SETVISIBLEBLOCK_H
#define SETVISIBLEBLOCK_H

#include "../../statementblock.h"
#include "../../expressionblock.h"

/**
 * @brief The SetVisibleBlock class
 *
 * @author Brecht Vandevoort
 */
class SetVisibleBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     ...
     * @brief Destructor
     */
    virtual ~SetVisibleBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Sprite_SetVisibleBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Set visible");}
     ...
     */
    virtual Block* newInstance() const {return new SetVisibleBlock();}
};

#endif // SETVISIBLEBLOCK_H
