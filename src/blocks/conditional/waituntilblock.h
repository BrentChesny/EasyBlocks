#ifndef WAITUNTILBLOCK_H
#define WAITUNTILBLOCK_H

#include "../../statementblock.h"
#include "../../expressionblock.h"

/**
 * @brief The WaitUntilBlock class
 *
 * @author Brecht Vandevoort
 */
class WaitUntilBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    WaitUntilBlock() : _condition(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~WaitUntilBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Control_WaitUntilBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Wait until") + QString(" %p");}
     ...
     */
    virtual Block* newInstance() const {return new WaitUntilBlock();}

private:
    ExpressionBlock* _condition;
};

#endif // WAITUNTILBLOCK_H
