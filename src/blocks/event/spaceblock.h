...
public:
     ...
     */
    virtual QString getId() const {return QString("Event_SpaceEventBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Spacebar Pressed");}
     ...
     */
    virtual Block* newInstance() const {return new SpaceBlock();}
};
