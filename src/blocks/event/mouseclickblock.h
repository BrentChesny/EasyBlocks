#ifndef MOUSECLICKBLOCK_H
#define MOUSECLICKBLOCK_H

#include "../../eventblock.h"

/**
 * @brief The MouseClickBlock class
 *
 * @author Brent Chesny
 */
class MouseClickBlock : public EventBlock
{
public:
    /**
     ...
     * @brief Destructor
     */
    virtual ~MouseClickBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Event_MouseClickEventBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Mousebutton Clicked");}
     ...
     */
    virtual Block* newInstance() const {return new MouseClickBlock();}
};

#endif // MOUSECLICKBLOCK_H
