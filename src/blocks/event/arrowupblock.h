#ifndef ARROWUPBLOCK_H
#define ARROWUPBLOCK_H


#include "../../eventblock.h"

/**
 * @brief The ArrowUpBlock class
 *
 * @author Brent Chesny
 */
class ArrowUpBlock : public EventBlock
{
public:
    /**
     ...
     * @brief Destructor
     */
    virtual ~ArrowUpBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Event_ArrowUpEventBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Arrow Up Pressed");}
     ...
     */
    virtual Block* newInstance() const {return new ArrowUpBlock();}
};

#endif // ARROWUPBLOCK_H
