#ifndef ARROWLEFTBLOCK_H
#define ARROWLEFTBLOCK_H


#include "../../eventblock.h"

/**
 * @brief The ArrowLeftBlock class
 *
 * @author Brent Chesny
 */
class ArrowLeftBlock : public EventBlock
{
public:
    /**
     ...
     * @brief Destructor
     */
    virtual ~ArrowLeftBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Event_ArrowLeftEventBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Arrow Left Pressed");}
     ...
     */
    virtual Block* newInstance() const {return new ArrowLeftBlock();}
};


#endif // ARROWLEFTBLOCK_H
