...
/**
 * @brief The StartBlock class
 *
 * @author Brent Chesny
 */
class StartBlock : public EventBlock
{
public:
    /**
     * @brief Constructor
     ...
     */
    virtual QString getId() const {return QString("Event_StartEventBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("On Start");}
     ...
     */
    virtual Block* newInstance() const {return new StartBlock();}
};
