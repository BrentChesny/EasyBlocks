...
/**
 * @brief The EnterBlock class
 *
 * @author Brent Chesny
 */
class EnterBlock : public EventBlock
{
public:
    /**
     ...
     */
    virtual QString getId() const {return QString("Event_EnterEventBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Enter Pressed");}
     ...
     */
    virtual Block* newInstance() const {return new EnterBlock();}
};
