#ifndef ARROWRIGHTBLOCK_H
#define ARROWRIGHTBLOCK_H


#include "../../eventblock.h"

/**
 * @brief The ArrowRightBlock class
 *
 * @author Brent Chesny
 */
class ArrowRightBlock : public EventBlock
{
public:
    /**
     ...
     * @brief Destructor
     */
    virtual ~ArrowRightBlock() {}

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Event_ArrowRightEventBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Arrow Right Pressed");}
     ...
     */
    virtual Block* newInstance() const {return new ArrowRightBlock();}
};

#endif // ARROWRIGHTBLOCK_H
