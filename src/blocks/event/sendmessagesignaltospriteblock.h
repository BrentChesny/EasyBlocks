#ifndef SENDMESSAGESIGNALTOSPRITEBLOCK_H
#define SENDMESSAGESIGNALTOSPRITEBLOCK_H
...
/**
 * @brief The SendMessageSignalToSpriteBlock class
 *
 * @author Brecht Vandevoort
 */
class SendMessageSignalToSpriteBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    SendMessageSignalToSpriteBlock() : _message(NULL), _spriteTarget(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~SendMessageSignalToSpriteBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Event_SendMessageSignalToSpriteBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Send message") + QString(" %p ") + QObject::tr("To Sprite:") + QString(" %p "); }
     ...
     */
    virtual Block* newInstance() const {return new SendMessageSignalToSpriteBlock();}

private:
    ExpressionBlock* _message;
    SpriteBlock* _spriteTarget;
};

#endif // SENDMESSAGESIGNALTOSPRITEBLOCK_H
