#ifndef BOOLASSIGNMENTBLOCK_H
#define BOOLASSIGNMENTBLOCK_H
...
/**
 * @brief The BoolAssignmentBlock class
 *
 * @author Brecht Vandevoort
 */
class BoolAssignmentBlock : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    BoolAssignmentBlock() : _variable(NULL), _expression(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~BoolAssignmentBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Boolean_BoolAssignment");}
     ...
     */
    virtual Block* newInstance() const {return new BoolAssignmentBlock();}
