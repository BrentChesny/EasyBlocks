#ifndef LOGICALANDBLOCK_H
#define LOGICALANDBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The LogicalAndBlock class
 *
 * @author Brecht Vandevoort
 */
class LogicalAndBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    LogicalAndBlock()  : _left(NULL), _right(NULL) {}
     ...
     */
    virtual QString getId() const {return QString("Boolean_LogicalAndBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QString("%p " + QObject::tr(" and ") + " %p");}
     ...
     */
    virtual Block* newInstance() const {return new LogicalAndBlock();}
