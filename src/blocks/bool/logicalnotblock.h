#ifndef LOGICALNOTBLOCK_H
#define LOGICALNOTBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The LogicalNotBlock class
 *
 * @author Brecht Vandevoort
 */
class LogicalNotBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    LogicalNotBlock()  : _expr(NULL) {}
     ...
     */
    virtual QString getId() const {return QString("Boolean_LogicalNotBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QString(QObject::tr(" not ") + " %p");}
     ...
     */
    virtual Block* newInstance() const {return new LogicalNotBlock();}

private:
    ExpressionBlock* _expr;
};

#endif // LOGICALNOTBLOCK_H
