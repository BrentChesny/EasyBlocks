#ifndef EQUALBOOLBLOCK_H
#define EQUALBOOLBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The EqualBoolBlock class
 *
 * @author Brecht Vandevoort
 */
class EqualBoolBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    EqualBoolBlock()  : _left(NULL), _right(NULL) {}

    /**
     * @brief Destructor method
     */
    virtual ~EqualBoolBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Boolean_EqualBoolBlock");}
     ...
     */
    virtual Block* newInstance() const {return new EqualBoolBlock();}
