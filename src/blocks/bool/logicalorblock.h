#ifndef LOGICALORBLOCK_H
#define LOGICALORBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The LogicalOrBlock class
 *
 * @author Brecht Vandevoort
 */
class LogicalOrBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    LogicalOrBlock()  : _left(NULL), _right(NULL) {}
     ...
     */
    virtual QString getId() const {return QString("Boolean_LogicalOrBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QString("%p " + QObject::tr(" or ") + " %p");}
     ...
     */
    virtual Block* newInstance() const {return new LogicalOrBlock();}
