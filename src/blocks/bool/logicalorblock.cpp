...
QList<Block::ParamType> LogicalOrBlock::getParamTypes() const
{
...
void LogicalOrBlock::executeNextStep(ExecutionThread& executionThread) const
{
...
bool LogicalOrBlock::addParameter(Block* parameter, int index)
{
