...
QList<Block::ParamType> MinusBlock::getParamTypes() const
{
...
void MinusBlock::executeNextStep(ExecutionThread& executionThread) const
{
...
bool MinusBlock::addParameter(Block* parameter, int index)
{
