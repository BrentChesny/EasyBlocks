#include "greaterthannumberblock.h"
...
GreaterThanNumberBlock::~GreaterThanNumberBlock()
{
    if(_left != NULL)
        delete _left;
    if(_right != NULL)
...
QList<Block::ParamType> GreaterThanNumberBlock::getParamTypes() const
{
...
bool GreaterThanNumberBlock::addParameter(Block* parameter, int index)
{
