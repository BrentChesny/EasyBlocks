...
EqualNumberBlock::~EqualNumberBlock()
{
    if(_left != NULL)
        delete _left;
    if(_right != NULL)
...
QList<Block::ParamType> EqualNumberBlock::getParamTypes() const
{
...
void EqualNumberBlock::executeNextStep(ExecutionThread& executionThread) const
{
...
bool EqualNumberBlock::addParameter(Block* parameter, int index)
{
