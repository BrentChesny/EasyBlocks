...
QList<Block::ParamType> DivideBlock::getParamTypes() const
{
...
void DivideBlock::executeNextStep(ExecutionThread& executionThread) const
{
...
bool DivideBlock::addParameter(Block* parameter, int index)
{
