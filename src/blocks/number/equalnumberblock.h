#ifndef EQUALNUMBERBLOCK_H
#define EQUALNUMBERBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The EqualNumberBlock class
 *
 * @author Brecht Vandevoort
 */
class EqualNumberBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor
     */
    EqualNumberBlock() : _left(NULL), _right(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~EqualNumberBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Number_EqualNumberBlock");}
     ...
     */
    virtual Block* newInstance() const {return new EqualNumberBlock();}
