...
QList<Block::ParamType> MultiplyBlock::getParamTypes() const
{
...
void MultiplyBlock::executeNextStep(ExecutionThread& executionThread) const
{
...
bool MultiplyBlock::addParameter(Block* parameter, int index)
{
