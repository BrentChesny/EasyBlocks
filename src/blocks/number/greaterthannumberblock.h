#ifndef GREATERTHANNUMBERBLOCK_H
#define GREATERTHANNUMBERBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The GreaterThanNumberBlock class
 *
 * @author Brent Chesny
 */
class GreaterThanNumberBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    GreaterThanNumberBlock()  : _left(NULL), _right(NULL) {}

    /**
     * @brief Destructor method
     */
    virtual ~GreaterThanNumberBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("Number_GreaterThanNumberBlock");}
     ...
     */
    virtual Block* newInstance() const {return new GreaterThanNumberBlock();}
...
#endif // GREATERTHANNUMBERBLOCK_H
