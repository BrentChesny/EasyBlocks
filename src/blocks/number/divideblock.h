#ifndef DIVIDEBLOCK_H
#define DIVIDEBLOCK_H

#include "../../expressionblock.h"

/**
 * @brief The DivideBlock class
 *
 * @author Brent Chesny
 */
class DivideBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor
     */
    DivideBlock() : _left(NULL), _right(NULL) {}
     ...
     */
    virtual QString getId() const {return QString("Number_DivideBlock");}
     ...
     */
    virtual Block* newInstance() const {return new DivideBlock();}
