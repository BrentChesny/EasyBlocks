#ifndef NUMBERLISTSIZE_H
#define NUMBERLISTSIZE_H

#include "../../expressionblock.h"
#include "../../listblock.h"

/**
 * @brief The NumberListSize class
 *
 * @author Brecht Vandevoort
 */
class NumberListSize : public ExpressionBlock
{
public:
    /**
     * @brief Constructor method
     */
    NumberListSize()  : _list(NULL) {}

    /**
     * @brief Destructor method
     */
    virtual ~NumberListSize();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("List_NumberListSize");}
     ...
     */
    virtual QString getParamDescription() const {return QString(QObject::tr(" Size of list ") + " %p");}
     ...
     */
    virtual Block* newInstance() const {return new NumberListSize();}

private:
    ListBlock* _list;
};

#endif // NUMBERLISTSIZE_H
