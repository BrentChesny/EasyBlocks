#ifndef APPENDNUMBERTOLIST_H
#define APPENDNUMBERTOLIST_H
...
/**
 * @brief The AppendNumberToList class
 *
 * @author Brecht Vandevoort
 */
class AppendNumberToList : public StatementBlock
{
public:
    /**
     * @brief Constructor
     */
    AppendNumberToList() : _value(NULL), _list(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~AppendNumberToList();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("List_AppendNumberToList");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Append value") + QString(" %p ") + QObject::tr("to list") + QString(" %p ");}
     ...
     */
    virtual Block* newInstance() const {return new AppendNumberToList();}
