#ifndef NUMBERFROMLISTBLOCK_H
#define NUMBERFROMLISTBLOCK_H

#include "../../expressionblock.h"
#include "../../listblock.h"

/**
 * @brief The NumberFromListBlock class
 *
 * @author Brecht Vandevoort
 */
class NumberFromListBlock : public ExpressionBlock
{
public:
    /**
     * @brief Constructor
     */
    NumberFromListBlock() : _index(NULL), _list(NULL) {}

    /**
     * @brief Destructor
     */
    virtual ~NumberFromListBlock();

    /**
     * @brief Returns a unique id of the block
     * @return A unique id specific to the block
     */
    virtual QString getId() const {return QString("List_NumberFromListBlock");}
     ...
     */
    virtual QString getParamDescription() const {return QObject::tr("Get element") + QString(" %p ") + QObject::tr("from") + QString(" %p");}
     ...
     */
    virtual Block* newInstance() const {return new NumberFromListBlock();}
