...
/**
 * @brief The ConstantBlock class
 *
 * @author Brecht Vandevoort
 */
class ConstantBlock : public ExpressionBlock
{
public:

    /**
     * @brief Constructor
     * @param value The Value the ConstantBlock will return when Executed
     */
    ConstantBlock(Value* value) : _value(value) {}
     ...
     */
    virtual Block* newInstance() const {return new ConstantBlock(NULL);}
